...
try:
    ...
    # Compiled CUDA extension not built yet (see Task 7 of the DVD AWQ-quant
    # plan). Only WQLinear.forward actually calls into it; ScaledActivation
    # and the int4 packing helpers below are pure PyTorch and don't need it,
    # so degrade gracefully instead of blocking every import of this module.
